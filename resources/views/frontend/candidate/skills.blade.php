            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="tab-content">
                        <h4 class="heading-caption">Skills</h4>
                        <div class="my_job_list row">
                            @if($users && $users->skills)
                            <div class="addnewworkexp text-right">
                                <a href="javascript:void(0)" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#mySkills">+ Add</a>
                            </div>
                            <div class="my-skills">{{$users->skills}}</div>
                            @else
                            <div class="no-record-found text-center">Skills are not added.<br><br> <a href="javascript:void(0)" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#mySkills">+ Add Skills</a></div>
                            @endif
                        </div>
                    </div>
                </div>
