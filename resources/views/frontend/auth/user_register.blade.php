      ...
      <div class="container-right">
         <div class="login-div text-center">
            <div class="login_block">
               ...
               <form method="POST" action="{{route('auth.user.register')}}" name="register_form">
                  @csrf         
                  ...
                  <div class="form-group">
                      ...
                      <input class="form-control" id="phone" name="phone_number" placeholder="Enter your phone number" required="" type="text" maxlength="10">
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="password_block position-relative">
                          ...
                          <button type="button" id="toggleConfirmPassword" class="btn position-absolute" 
                                  style="right: 10px; top: 50%; transform: translateY(-50%); background: transparent; border: none;">
                  ...
                  <div class="form-check">
                      <label class="form-check-label" for="customCheck1">
                          ...
                          I agree to <span><a href="#" target="_blank" id="terms" class="text-primary">Terms of Services</a> &amp; 
                          <a href="#" target="_blank" id="privacy" class="text-primary">Privacy Policy</a></span>
                      </label>
                  </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#toggleConfirmPassword").click(function () {
            ...
            let eyeIconConfirm = $("#eyeIconConfirm");
