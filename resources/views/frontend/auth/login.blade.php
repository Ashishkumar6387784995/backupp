   ...
   <div class="login-container">
    ...
    <div class="container-right">
      <div class="login-div text-center"> 
        <h4 class="mt-3">Sign In into continue</h4>
        <div>
          @error('email')
        ...
        <form class="form" novalidate="novalidate" id="kt_login_signin_form" action="" method="post">
          ...
          <div class="in-div">
            <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="text" name="email" autocomplete="off" required placeholder="Enter Email Id" />
          </div>
          <div class="in-div">
            <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="password" name="password" autocomplete="off" required placeholder="Enter Password" />
          </div>
          <div class="in-div">
            <button type="submit" name="submit" class="btn btn-success btn-submit">Sign In <span></span></button>
          </div> 
          <div class="in-div">
            New to Backupp? <a href="{{url('/registration')}}">Sign Up Here</a>
          </div>
        </form>
