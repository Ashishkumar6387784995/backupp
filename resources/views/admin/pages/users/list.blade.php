        ...
        <table class="table table-bordered table-hover" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0)" data-url="{{url('admin/users/update-status/'.$value->id.'/'.$value->status)}}" onclick="changeStatus(this)"> <span class="label label-lg font-weight-bold label-light-{{($value->is_active == 1) ? 'success' : 'danger'}} label-inline">{{($value->is_active == 1) ? 'Active' : 'InActive'}}</span></a>
                    </td>
