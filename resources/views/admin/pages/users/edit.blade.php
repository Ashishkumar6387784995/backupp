                    ...
                    <div class="col-lg-9 col-xl-12">
                        <div class="row align-items-center">
                            <div class="form-group col-md-6">
                                <label>Name</label>
                                <div><input type="text" name="name" value="{{$details->first_name}}" isrequired="required" class="form-control" placeholder="Enter User Name"></div>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div><input type="text" name="mobile" value="{{$details->phone}}" isrequired="required" class="form-control" placeholder="Enter Mobile Number"></div>
                            </div>
                            <!-- <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="role_id" id="role_id" isrequired="required">
                                    ...
                                    <option value="{{$role->id}}" {{runTimeSelection($details->role_id,$role->id)}}>{{ $role->name }}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
