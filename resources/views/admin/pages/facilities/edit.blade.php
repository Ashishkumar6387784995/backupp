                    ...
                    <div class="col-lg-9 col-xl-12">
                        <div class="row align-items-center">
                            <div class="form-group col-md-12">
                                ...
                                <div><input type="text" name="facility_name"  value="{{$details->facility_name}}" class="form-control" placeholder="Enter Facility Name" isrequired="required"></div>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Facility Icon <small>(Width:96px, Height: 96px)</small></label>
                                @if($details['facility_icon'])
                                <div class="_update_img_action">
                                    <a target="_black" href="{{asset('uploads/facility/'.$details['facility_icon'])}}" class="btn btn-success btn-sm">View</a> &nbsp;
                                    <a href="javascript:void(0)" class="btn btn-danger btn-sm" onclick="updateImage(this)">Update</a>
                                </div>
                                @endif
                                <div class="image_file _update_img_file" style="{{$details['facility_icon'] ? 'display:none' : ''}}">
