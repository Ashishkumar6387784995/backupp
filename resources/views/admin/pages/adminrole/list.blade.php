...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-3 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="{{url('/admin/roles/add')}}" class="btn btn-primary font-weight-bolder">
        ...
        <table class="table table-bordered table-hover" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$value->role }}</td>
                    <!-- <td>
                        <a href="javascript:void(0)" data-url="{{url('admin/customers/update-status/'.$value->id.'/'.$value->status)}}" onclick="changeStatus(this)">
                    ...
                    <td>
                        <a href="{{url('/admin/roles/edit/'.$value->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit details" data-toggle="tooltip">
                            <i class="la la-edit"></i>
                        </a>
                        {{-- <a href="{{url('/admin/roles/permissions/'.$value->id)}}" class="btn btn-sm btn-clean btn-icon" title="View Permissions" data-toggle="tooltip">
