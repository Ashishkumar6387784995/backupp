 @extends('admin.pages.auth.layout',['page_title' => 'Super Admin Login'])
             ...
             <div class="login-div text-center">
                 ...
                 <form class="form" novalidate="novalidate" id="kt_login_signin_form" action="{{url('admin/auth/login')}}" method="post">
                     ...
                     <div class="in-div position-relative">
                        <input id="passwordField" class="form-control form-control-solid h-auto py-6 px-6 rounded-lg pr-5" 
