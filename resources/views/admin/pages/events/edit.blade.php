                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="row form-group col-md-12">
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        <input type="date" name="date" value="{{$details->date}}" class="form-control" placeholder="Event date" isrequired="required">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Event Time</label>
                                    <div>
                                        <input type="time" name="time" value="{{$details->time}}" class="form-control" placeholder="Event time">
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div>
                                    <input type="text" name="location" value="{{$details->location}}" class="form-control" placeholder="Event location" isrequired="required">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Event Organized By</label>
                                <div>
                                    <input type="text" name="posted_by" value="{{$details->posted_by}}" class="form-control" placeholder="Event Organized By" isrequired="required">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Event Description</label>
                                <div>
                                    <textarea id="textEditor1" name="description" class="form-control" placeholder="Enter Description">{{$details->details}}</textarea>
                                </div>
                            </div>
                            <div class="row form-group col-md-12">
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="_update_img_action">
                                        <br>
                                        <a target="_black" href="{{asset('uploads/event/videos/'.$video['video'])}}" class="btn btn-success btn-sm">View</a> &nbsp;
                                        <a href="javascript:void(0)" data-url="{{url('/admin/events/delete-video/'.$details->id.'/'.$video['video'])}}" class="btn btn-danger btn-sm" onclick="deleteImage(this)">Delete</a>
                                    </div>
                                    @endforeach
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="_update_img_action">
                                        <br>
                                        <a target="_black" href="{{asset('uploads/event/images/'.$contract_document['image'])}}" class="btn btn-success btn-sm">View</a> &nbsp;
                                        <a href="javascript:void(0)" data-url="{{url('/admin/events/delete-image/'.$details->id.'/'.$contract_document['image'])}}" class="btn btn-danger btn-sm" onclick="deleteImage(this)">Delete</a>
                                    </div>
                                    @endforeach
                                    @endif
                                </div>
