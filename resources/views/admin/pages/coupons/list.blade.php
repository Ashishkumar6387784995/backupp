    ...
    <div class="card-header flex-wrap border-0 pt-3 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <a href="{{url('/admin/offers/add')}}" class="btn btn-primary font-weight-bolder">
                <i class="la la-plus"></i>Add a New Offer</a>
            <!--end::Button-->
        </div>
                ...
                <div class="col-sm-3">
                    <div class="dataTables_length">
                        ...
                        <select class="form-control" name="coupon_type" id="coupon_type" isrequired="required">
                            ...
                            <option value="1" {{runTimeSelection(1,request('coupon_type'))}}>Percentages</option>
                            <option value="2" {{runTimeSelection(2,request('coupon_type'))}}>Fixed</option>
                            <option value="3" {{runTimeSelection(3,request('coupon_type'))}}>Conditional</option>
                        </select>
                    </div>
                </div>
                <div class="col-sm-5">
                    <div class="dataTables_length">
                        ...
                        <a href="{{url('/admin/offers/list')}}" class="btn btn-default mt-7" data-toggle="tooltip" title="Reset">Reset</a>
                    </div>
                </div>
            </div>
        </form>
        ...
        <table class="table table-bordered table-hover" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0)" data-url="{{url('admin/offers/update-status/'.$value->id.'/'.$value->status)}}" onclick="changeStatus(this)">
                    ...
                    <td>
                        <a href="{{url('/admin/offers/edit/'.$value->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit details" data-toggle="tooltip">
