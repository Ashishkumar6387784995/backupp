                ...
                <form method="POST" action="" class="w-100" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-9 col-xl-12">
                        <div class="row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label>Email</label>
                                <div><input type="text" name="email" value="{{old('email')}}" class="form-control" placeholder="Enter Email Address"></div>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Mobile Number</label>
                                <div><input type="text" name="mobile" value="{{old('mobile')}}" class="form-control number" placeholder="Enter Mobile Number"></div>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Date of Birth</label>
                                <div><input type="date" name="dob" class="form-control" value="{{old('dob')}}" max="{{date('Y-m-d',strtotime('-26 years'))}}"></div>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Gender</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="city_id">
                                    ...
                                    <option value="{{$city->id}}" {{runTimeSelection($city->id,old('city_id'))}}>{{$city->name }}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="text" name="designation" value="{{old('designation')}}" isrequired="required" class="form-control" placeholder="Enter Designation">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div><input type="text" name="area_of_interest" value="{{old('area_of_interest')}}" class="form-control" placeholder="Enter Area of Interest"></div>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Expertise</label>
                                <textarea class="form-control" name="expertise" value="{{old('expertise')}}" id="" cols="30" rows="10" placeholder="Enter Doctor Expertise">{{old('expertise')}}</textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Details</label>
                                <textarea id="editor1" class="form-control" name="details" id="" cols="30" rows="10" placeholder="Enter Doctor Details">{{old('details')}}</textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Research Publication Details</label>
                                <textarea id="editor2" class="form-control" name="research_publication" id="" cols="30" rows="10" placeholder="Enter Research Publication Details">{{old('research_publication')}}</textarea>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="text" name="main_video_youtube_link" class="form-control" value="">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
