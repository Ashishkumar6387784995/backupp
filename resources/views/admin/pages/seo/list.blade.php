...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-3 pb-0">
        <div class="card-title">
            <h3 class="card-label">SEO Management
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="{{url('/admin/seo/add')}}" class="btn btn-primary font-weight-bolder">
                <i class="la la-plus"></i>Add Page</a>
            <!--end::Button-->
        </div>
            ...
            <div class="row col-lg-12 pl-0 pr-0">
                ...
                <div class="col-sm-5">
                    <div class="dataTables_length">
                        ...
                        <a href="{{url('/admin/seo/list')}}" class="btn btn-default mt-7" data-toggle="tooltip" title="Reset">Reset</a>
                    </div>
                </div>
            </div>
        </form>
        ...
        <table class="table table-bordered table-hover" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0)" data-url="{{url('admin/seo/update-status/'.$value->id.'/'.$value->status)}}" onclick="changeStatus(this)">
                    ...
                    <td>
                        <a href="{{url('/admin/seo/edit/'.$value->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit details" data-toggle="tooltip">
