...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-3 pb-0">
        <div class="card-title">
            <h3 class="card-label">Testimonials
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="{{url('/admin/testimonials/add')}}" class="btn btn-primary font-weight-bolder">
                <i class="la la-plus"></i>Add Testimonial</a>
            <!--end::Button-->
        </div>
            ...
            <div class="row col-lg-12 pl-0 pr-0">
                ...
                <!-- <div class="col-sm-3">
                    <div class="dataTables_length">
                        <label>City</label>
                        <select name="city_id" value="" class="form-control">
        ...
        <table class="table table-bordered table-hover" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0)" data-url="{{url('admin/testimonials/update-status/'.$value->id.'/'.$value->status)}}" onclick="changeStatus(this)">
                    ...
                    <td>
                        <a href="{{url('/admin/testimonials/edit/'.$value->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit details" data-toggle="tooltip">
