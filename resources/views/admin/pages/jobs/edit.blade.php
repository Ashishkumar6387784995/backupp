                    ...
                    <div class="col-lg-9 col-xl-12">
                        <div class="row align-items-center">
                            <div class="form-group col-md-6">
                                <label>Company</label>
                                <div>
                                    @php $companies = getCompanies(1); @endphp
                                    <select class="form-control" name="company_id" isrequired="required">
                                        <option value="">--Company Name--</option>
                                        @if($companies)
                                        @foreach($companies as $list)
                                        <option value="{{$list->id}}" data-name="{{$list->name}}" {{runTimeSelection($list->id,$details->company_id)}}>{{$list->company_name}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
