                        ...
                        <div class="row mt-6 mt-6" id="contact_detail_info">
                          ...
                          <div class="form-group col-md-6">
                           ...
                           <div class="form-group col-md-12">
                              ...
                              <textarea type="text" cols="3" class="form-control" id="contact_address" name="contact_address" placeholder="Enter address"></textarea>
                          </div>
                  ...
                  <div class="card">
                     <div class="card-body">
                        ...
                        <div class="contact_info_com">
                           ...
                           <div class="col-md-12">
                              <h5 class="company-name">Spyfoxx</h5>
                              <div class="">
                                 <div class="text-truncate mb-2">
                                    <i class="far fa-envelope me-2"></i> <span id=" ">Email Id: wali@backupp.com.au</span> 
                                 </div>
                                 <div class="text-truncate mb-2">
                                    <i class="fas fa-phone-volume"></i>
                                    <span id=" ">Phone:  3453453</span> 
                                 </div>
                              </div>
...
async function nextStep(step) {
    ...
    if (step === 6) {
        // Step 5: Payment Plan Validation
         updatePreviewFields();
         showStep(step);
    }
