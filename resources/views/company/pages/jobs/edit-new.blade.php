      ...
      <div class="col-sm-12">
         <form id="multiStepForm" action="{{ route("company.job.update",["id"=>request("id")]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="step row" id="step1">
               <div class="col-sm-7 main_card_scroll">
                  <div class="card job-left-side-card">
                     <div class="card-body">
                                    ...
                                    <select class="form-control select2" name="job_type" id="job_type" isrequired="required">
                                       ...
                                       @if (!empty($jobTypes))
                                          @foreach ($jobTypes as $key => $jtype)
                                             <option value="{{ $jtype->id }}" {{runTimeSelection($jtype->id, $details->job_type)}}>{{ $jtype->name }}</option>
                                          @endforeach
                                       @endif
