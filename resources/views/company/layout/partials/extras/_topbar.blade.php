...
<div class="topbar">
    ...
    <div class="dropdown">
        ...
        <div class="topbar-item">
            <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
                ...
                <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ auth()->guard('company')->check() ? auth()->guard('company')->user()->first_name : 'Company'}}</span>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
            @include('company.layout.partials.extras.dropdown._user')
        </div>
    </div>
    @endif
    @endif
